...
import com.sirius.vpn.common.utils.RootShell.RootShellException.Reason;
...
public class RootShellCmd {
    ...
    public RootShellCmd() {
        localBinaryDir = new File("/Users/sirius", "bin");
        localTemporaryDir = new File("/Users/sirius", "tmp");
        preamble = String.format("export CALLING_PACKAGE=%s PATH=\"%s:$PATH\" TMPDIR='%s'; id -u\n",
                "siriuscmd", localBinaryDir, localTemporaryDir);
    }
